...
describe('Blue Lightning', function () {
  ...
  it('Course Enrollment Summary', function () {
    ...
    //----------------------[By clicking Reports without empty fields]----------------------//
  ...
  it('Course enrollment details', function () {
    ...
    cy.get('bl-wc-rlp-report')
      .shadow()
      .find('.card-header-summary.bg-white>div:nth-child(2)>div:nth-child(8)')
      .click()
    cy.get('bl-wc-rlp-report')
      .shadow()
      .find(
...
it('Module Enrollment Summary', function () {
  ...
  cy.get('bl-wc-rlp-report')
    .shadow()
    .find('.card-header-summary.bg-white>div:nth-child(2)>div:nth-child(5)')
    .click()
  cy.get('bl-wc-rlp-report')
    .shadow()
    .find(
...
it('Module enrollement details', function () {
  ...
  cy.get('bl-wc-rlp-report')
    ...
    .find('.card-header-summary.bg-white>div:nth-child(2)>div:nth-child(5)')
    .click()
  //cy.get('bl-wc-rlp-report').shadow().find('.absolute.mt-2.right-0.z-20.w-48.py-2>div>div:nth-child(1)>div>input').check()
  cy.wait(3000)
  //cy.get('bl-wc-rlp-report').shadow().find('.absolute.mt-2.right-0.z-20.w-48.py-2>div>div:nth-child(2)>div>input').check()
  cy.get('bl-wc-rlp-report')
    .shadow()
